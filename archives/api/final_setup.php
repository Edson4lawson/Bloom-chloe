<?php
/**
 * Script final pour créer la base de données bloom_chloe
 */
...
try {
    ...
    $products = [
        ['Robe Soirée Élégante', 'Robe longue en soie parfaite pour les occasions spéciales', 45000.00, 1, 'robe-soiree-elegante'],
        ['Robe d\'Été Florale', 'Robe légère avec motif floral pour l\'été', 25000.00, 1, 'robe-ete-florale'],
        ['Talons Hauts Noirs', 'Talons aiguilles élégants de 12cm', 35000.00, 2, 'talons-hauts-noirs'],
        ['Bottines en Cuir', 'Bottines confortables en cuir véritable', 55000.00, 2, 'bottines-cuir'],
        ['Sac à Main Luxe', 'Sac à main en cuir avec fermoir doré', 75000.00, 4, 'sac-main-luxe'],
        ['Sacoche Tendance', 'Sacoche moderne pour un look casual', 28000.00, 4, 'sacoche-tendance'],
        ['Collier Perles', 'Collier élégant en perles de culture', 18000.00, 5, 'collier-perles'],
        ['Bracelet Or', 'Bracelet fin en plaqué or', 22000.00, 5, 'bracelet-or']
    ];
