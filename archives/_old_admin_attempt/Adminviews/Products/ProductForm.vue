  ...
  <div class="p-6">
    <div class="max-w-4xl mx-auto">
      <div class="flex justify-between items-center mb-6">
        ...
        <router-link to="/yubuy-manager/products" class="text-gray-600 dark:text-slate-400 hover:text-gray-800 dark:hover:text-white">
          ← Retour à la liste
        </router-link>
      </div>
...
const saveProduct = async () => {
  ...
  try {
    ...
    if (response.success) {
      ...
      router.push('/yubuy-manager/products')
    }
  } catch (error) {
