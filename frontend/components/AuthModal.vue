<template>
  <div class="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-[200] p-4 overflow-y-auto">
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8 relative max-h-[90vh] overflow-y-auto">
      <!-- Close Button -->
...
const handleLogin = async () => {
  ...
  try {
    ...
    if (user && user.role === 'admin') {
      ...
      // À€ adapter plus tard vers une vraie page compte client (/mon-compte)
