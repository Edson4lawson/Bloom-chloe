        ...
        <div class="w-screen max-w-md bg-white shadow-2xl flex flex-col">
          ...
          <div class="px-6 py-5 border-b border-gray-100 flex items-center justify-between bg-purple-50/50">
            <div class="flex items-center space-x-3">
              <div class="w-10 h-10 rounded-xl bg-purple-500 flex items-center justify-center text-white shadow-lg shadow-purple-100">
          ...
          <div class="flex-1 overflow-y-auto py-6 px-6">
            <div v-if="wishlistStore.isEmpty" class="h-full flex flex-col items-center justify-center text-center space-y-4">
              ...
              <div>
                ...
                <p class="text-gray-400">Sauvegardez vos coups de cÅ“ur pour plus tard.</p>
              </div>
