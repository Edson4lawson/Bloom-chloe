...
export const orderService = {
    ...
    getUserOrders: () => api.get('/orders/get_user_orders.php'),
    getOne: (id) => api.get(`/orders/get_user_orders.php?order_id=${id}`)
};
...
export const authService = {
    ...
    forceLogout: () => {
        ...
        // Recharger la page pour vider le store Pinia en mémoire et forcer la mise à jour de l'UI
