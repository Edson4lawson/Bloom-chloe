        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          ...
          <div class="space-y-4">
            <div class="relative aspect-square bg-white rounded-3xl overflow-hidden border border-purple-50 shadow-xl group">
              ...
              />
              <div v-if="product.discount" class="absolute top-4 right-4 bg-pink-500 text-white text-xs font-black px-3 py-1.5 rounded-full shadow-lg">
                -{{ product.discount }}%
              </div>
              <!-- Wishlist button -->
              <button @click="toggleWishlist" class="absolute top-4 left-4 w-10 h-10 bg-white/90 backdrop-blur rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-all">
                <Icon :icon="isInWishlist ? 'solar:heart-bold' : 'solar:heart-linear'" class="w-5 h-5" :class="isInWishlist ? 'text-pink-500' : 'text-gray-600'" />
              </button>
            </div>
            <!-- Thumbnail strip -->
